...
const devices = [
  ...
  ,
  {
    ...
    },
    {
      ...
      fallbackImage: '/images/Total%20Wellness%20Capsule/_DSC5182.JPG',
      benefits: [
    ...
    },
    {
      ...
      fallbackImage: '/images/EMS%20Kegel%20Chair%20/IMG_0663_(1).jpg',
      benefits: [
    ...
    },
    {
      ...
      fallbackImage: '/images/FIR%20Sauna%20/_DSC5199.JPG',
      benefits: [
    ...
    },
    {
      ...
      fallbackImage: '/images/Cryo%20EMS%20/SGRC0689.JPG',
      benefits: [
    ...
    >
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-slate-900/90 via-slate-900/70 to-transparent backdrop-blur-sm border-b border-white/10">
        <div className="flex justify-between items-center px-4 sm:px-6 md:px-8 lg:px-12 py-3 sm:py-4 md:py-6">
          ...
          >
                              <a href="/wellness-devices" className="text-white/80 hover:text-cyan-200 text-xs sm:text-sm md:text-base tracking-[0.05em] sm:tracking-[0.1em] uppercase font-medium transition-all duration-300 hover:scale-105">
                    Gallery
                  </a>
