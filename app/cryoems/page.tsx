...
const deviceData = {
  ...
  description:
    'CryoEMS offers an unparalleled 2-in-1 advantage: cryolipolysis and electrical muscle stimulation combined in one device. This combination reduces fat, improves complexion, and tightens tissue. With cold handpieces, it also enables facial treatments and delivers a complete wellness package.',
  rating: 4.8,
  ...
  specs: [
    { name: 'Power cord length', value: '200cm' },
    { name: 'Housing material', value: 'Acrylic glass' },
    { name: 'Care product', value: 'Polishing paste for cryo plates' },
    { name: 'Power', value: '230V / 10A / 50Hz' }
  ]
};

export default function CryoEMSPage() {
