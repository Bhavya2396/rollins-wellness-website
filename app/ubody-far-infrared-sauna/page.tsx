...
const deviceData = {
  ...
  model: 'DETOX SAUNA',
  description:
    'The Ubody Far Infrared Sauna is a modern detox solution that uses far-infrared heat to deeply penetrate tissues. Unlike traditional saunas, it promotes sweating at lower, more comfortable temperatures, making it ideal for relaxation and detoxification.',
  rating: 4.8,
  ...
  specs: [
    { name: 'Heating', value: 'Far-infrared heating panels' },
    { name: 'Design', value: 'Pod or cabin-style design' },
    { name: 'Controls', value: 'Adjustable heat levels' },
    { name: 'Options', value: 'Optional entertainment integration' }
  ]
};

export default function UbodyFarInfraredSaunaPage() {
                  ...
                  <motion.div
                    ...
                    className={`flex items-start gap-3 p-3 rounded-lg border ${
                      index === activeBenefitIndex
                        ? 'border-orange-400/60 bg-orange-900/20 shadow-lg shadow-orange-500/10'
