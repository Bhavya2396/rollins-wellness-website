...
const deviceData = {
  ...
  description:
    'This wellness pod combines Pulsed Electromagnetic Field (PEMF) therapy with negative ion technology to support cellular repair and overall wellness. PEMF stimulates energy production in cells, while negative ions enhance detoxification and vitality.',
  rating: 4.7,
  ...
  specs: [
    { name: 'PEMF', value: 'Integrated PEMF coils' },
    { name: 'Negative Ions', value: 'Negative ion emitters' },
    { name: 'Design', value: 'Pod-style enclosure' },
    { name: 'Intensity', value: 'Adjustable intensity levels' }
  ]
};
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="text-white text-xl font-bold hover:text-emerald-400 transition-colors">
              ← Back to Home
            </Link>
            ...
            <div className="h-full w-full rounded-xl overflow-hidden border border-white/10 bg-black/20">
              <Suspense fallback={<div className="w-full h-full flex items-center justify-center text-white">Loading 3D...</div>}>
                <MedicalDevice3D
                  ...
                  category="Cellular Wellness Pod"
