...
const deviceData = {
  ...
  description:
    'The Total Wellness Capsule integrates multiple therapies—infrared heat, vibration, detoxification, and LED light therapy—into one enclosed pod. It delivers a relaxing full-body wellness experience while stimulating circulation, detoxification, and weight management. Popular in spas and wellness centers for its holistic approach.',
  rating: 4.8,
  ...
  specs: [
    { name: 'Design', value: 'Pod-style capsule' },
    { name: 'Therapies', value: 'Infrared + LED + vibration therapy' },
    { name: 'Programs', value: 'Multi-program settings' },
    { name: 'Controls', value: 'Touchscreen control panel' }
  ]
};
                  ...
                  <motion.div
                    ...
                    className={`flex items-start gap-3 p-3 rounded-lg border ${
                      index === activeBenefitIndex
                        ? 'border-amber-400/60 bg-amber-900/20 shadow-lg shadow-amber-500/10'
