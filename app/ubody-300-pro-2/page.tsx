...
const deviceData = {
  ...
  specs: [
    { name: 'Design', value: 'Pod-style with LED spectrum therapy' },
    { name: 'Controls', value: 'Touchscreen control panel' },
    { name: 'Modes', value: 'Multi-program therapy modes' },
    { name: 'Build', value: 'Compact & ergonomic build' }
  ]
};
...
export default function UBody300Pro2Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-orange-900/25 to-slate-900">
      {/* Navigation */}
