...
const deviceData = {
  ...
  description:
    'This electrical cryotherapy chamber offers whole-body treatments without the use of nitrogen. By maintaining safe, breathable air, it ensures maximum safety and comfort for clients. It is ideal for athletes, recovery centers, and wellness clinics seeking a safe, sustainable cryotherapy solution.',
  rating: 4.8,
  ...
  specs: [
    { name: 'System', value: 'Electrical cooling system' },
    { name: 'Temperature', value: '-110°C to -140°C' },
    { name: 'Safety', value: 'Safe air-only system' },
