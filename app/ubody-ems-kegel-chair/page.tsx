...
const deviceData = {
  ...
  description:
    'The Ubody EMS Kegel Chair provides non-invasive pelvic floor therapy using high-intensity focused EMS technology. By inducing powerful muscle contractions, it strengthens pelvic floor muscles and supports intimate wellness. Designed for comfort and privacy, it offers effective results without downtime or invasive procedures.',
  rating: 4.8,
  ...
  specs: [
    { name: 'System', value: 'Chair-based EMS treatment' },
    { name: 'Programs', value: 'Adjustable treatment programs' },
    { name: 'Interface', value: 'Touchscreen interface' },
    { name: 'Ergonomics', value: 'Ergonomic seating design' }
  ]
};

export default function UbodyEmsKegelChairPage() {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="text-white text-xl font-bold hover:text-pink-400 transition-colors">
              ← Back to Home
            </Link>
                  ...
                  <motion.div
                    ...
                    className={`flex items-start gap-3 p-3 rounded-lg border ${
                      index === activeBenefitIndex
                        ? 'border-pink-400/60 bg-pink-900/20 shadow-lg shadow-pink-500/10'
